...
*/
    ...
    function t(a, b) {
        if (b)
            a: {
                ...
                d = c[a];
                b = b(d);
                b != d && null != b && p(c, a, { configurable: !0, writable: !0, value: b });
            }
    }
    t("Symbol", function (a) {
        function b(g) {
    ...
    function pa(a, b) {
        ...
        this.i = {};
        var d,
            f = Q("dropdown-wrapper", [(d = Q("dropdown", [Q("dropdown-trigger", [(this.h = R()), Q("arrow")]), (this.options = Q("dropdown-options"))]))]);
        f.onclick = function () {
            a.C && a.C();
        ...
        for (var g = {}, e = v(a.options), h = e.next(); !h.done; g = { s: g.s }, h = e.next())
            (g.s = h.value),
                (h = void 0),
    ...
    var ta = { facingMode: "user", width: 640, height: 480 },
        ua = { allowVideo: !0, allowImage: !0, examples: { videos: [], images: [] } };
    function X(a) {
    ...
    function va(a) {
        return L(a, function c() {
            ...
            return I(c, function (k) {
                if (1 == k.g) return F(k, navigator.mediaDevices.getUserMedia({ video: !0 }), 2);
                if (3 != k.g) return F(k, navigator.mediaDevices.enumerateDevices(), 3);
                d = k.l;
                f = [];
                g = v(d);
                for (e = g.next(); !e.done; e = g.next()) (h = e.value), "" !== h.label && f.push({ label: h.label, deviceId: h.deviceId });
                return k.return(f);
            });
        });
    }
    ...
    Y.prototype.tick = function () {
        ...
        this.j &&
            (this.video.paused ||
                ...
                (this.m || (wa(this, this.video.currentTime / this.video.duration), (this.i.time.textContent = xa(this.video.currentTime))),
                (this.A = this.video.currentTime),
                (b = this.g.onFrame ? this.g.onFrame(this.video, { width: this.video.videoWidth, height: this.video.videoHeight }) : null)),
            b
                ? b.then(function () {
                      Z(a);
                  })
        ...
        a.o = new pa(
            {
                options: a.l.map(function (c) {
                    var d = void 0;
                    "image" === c.type
                        ? (d = S("https://fonts.gstatic.com/s/i/googlematerialicons/image/v12/gm_grey-24dp/1x/gm_image_gm_grey_24dp.png"))
                        : "video" === c.type && (d = S("https://fonts.gstatic.com/s/i/googlematerialicons/videocam/v12/gm_grey-24dp/1x/gm_videocam_gm_grey_24dp.png"));
                ...
                return I(f, function (n) {
                    if ((g = c.files) && 0 < g.length) {
                        ...
                        if (
                            ...
                            !(
                                /^image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)$/i.test(m[1]) ||
                                /^video\/(?:mpeg|mp4|ogg|webm|x-matroska|quicktime|x-ms-wmv)$/i.test(m[1]) ||
                                /^audio\/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)$/i.test(m[1])
                            )
                        )
    ...
    Y.prototype.update = function () {
        if (this.h && !this.j && this.g.onFrame) this.g.onFrame(this.h, { width: this.h.naturalWidth, height: this.h.naturalHeight });
    };
    function Ka(a) {
        this.g = a;
    }
